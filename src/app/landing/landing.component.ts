...
// //screenshot slider
// (<any>$('.mobile-carousel-slider')).owlCarousel({
//   loop:true,
//   margin:70,
//   dots:false,
//   nav:true,
...
// //hero content slider
// (<any>$('.hero-content-slider')).owlCarousel({
//   loop:true,
//   margin:70,
//   dots:false,
//   nav:true,
...
// (<any>$('.hero-background-slider')).owlCarousel({
//   loop: true,
//   items: 1,
//   autoplay: true,
//   dots: true,
...
// // 6. customers slider
// (<any>$('.customers-slider')).owlCarousel({
//   autoplay: true,
//   loop: true,
//   margin:25,
//   dots:false,
...
// =============================*/
// (<any>$('.list_screen_slide')).owlCarousel({
//   loop: true,
//   responsiveClass: true,
//   nav: false,
//   margin: 5,
...
// (<any>$(".player")).mb_YTPlayer();

// //  9. typed
// // var typed = $(".typed");
// // $(function() {
// //   typed.typed({
// //       strings: ["By Parth Vijayvargiya", "Youtuber", " Career Guide" , "Engineer"],
// //       typeSpeed: 130,
// //       loop: true
// //   });
// // });
